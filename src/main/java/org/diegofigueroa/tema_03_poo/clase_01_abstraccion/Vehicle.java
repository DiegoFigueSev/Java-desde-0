package org.diegofigueroa.tema_03_poo.clase_01_abstraccion;


/**
 * Que es la abstraccion?
 *
 * La abstraccion es la capacidad de modelar lo importante de un objeto en el mundo real
 * ocultando los detalles de un objeto
 *
 * Abstraer = quedarte con lo esencial
 */
